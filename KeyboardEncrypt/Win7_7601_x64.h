...
struct _MY_EPROCESS_WIN7_7601_X64_
{
	UCHAR PcbAndOthers[0x300]; // +0x000 Pcb              : _KPROCESS
	...
	LIST_ENTRY ThreadListHead; // 	+ 0x300 ThreadListHead : _LIST_ENTRY
...
struct _MY_ETHREAD_WIN7_7601_X64_
{
...
struct _MY_KTHREAD_WIN7_7601_X64_
{
