...
struct _MY_EPROCESS_WIN10_1703_X86_
{
	...
	// 	+ 0x0c8 DisallowStrippedImages : Pos 24, 1 Bit
	// 	+ 0x0c8 HighEntropyASLREnabled : Pos 25, 1 Bit
	// 	+ 0x0c8 ExtensionPointDisable : Pos 26, 1 Bit
	// 	+ 0x0c8 ForceRelocateImages : Pos 27, 1 Bit
	// 	+ 0x0c8 ProcessStateChangeRequest : Pos 28, 2 Bits
	// 	+ 0x0c8 ProcessStateChangeInProgress : Pos 30, 1 Bit
	// 	+ 0x0c8 DisallowWin32kSystemCalls : Pos 31, 1 Bit
	// 	+ 0x0cc Flags : Uint4B
	...
	// 	+ 0x0cc ControlFlowGuardEnabled : Pos 4, 1 Bit
	...
	// 	+ 0x2f7 HangCount : UChar
	// 	+ 0x2f8 Flags3 : Uint4B
	// 	+ 0x2f8 Minimal : Pos 0, 1 Bit
	// 	+ 0x2f8 ReplacingPageRoot : Pos 1, 1 Bit
	// 	+ 0x2f8 DisableNonSystemFonts : Pos 2, 1 Bit
	// 	+ 0x2f8 AuditNonSystemFontLoading : Pos 3, 1 Bit
	// 	+ 0x2f8 Crashed : Pos 4, 1 Bit
	// 	+ 0x2f8 JobVadsAreTracked : Pos 5, 1 Bit
	// 	+ 0x2f8 VadTrackingDisabled : Pos 6, 1 Bit
	// 	+ 0x2f8 AuxiliaryProcess : Pos 7, 1 Bit
	// 	+ 0x2f8 SubsystemProcess : Pos 8, 1 Bit
	// 	+ 0x2f8 IndirectCpuSets : Pos 9, 1 Bit
	// 	+ 0x2f8 InPrivate : Pos 10, 1 Bit
	// 	+ 0x2f8 ProhibitRemoteImageMap : Pos 11, 1 Bit
	// 	+ 0x2f8 ProhibitLowILImageMap : Pos 12, 1 Bit
	// 	+ 0x2f8 SignatureMitigationOptIn : Pos 13, 1 Bit
	// 	+ 0x2f8 DisableDynamicCodeAllowOptOut : Pos 14, 1 Bit
	// 	+ 0x2f8 EnableFilteredWin32kAPIs : Pos 15, 1 Bit
	// 	+ 0x2f8 AuditFilteredWin32kAPIs : Pos 16, 1 Bit
	// 	+ 0x2f8 PreferSystem32Images : Pos 17, 1 Bit
	// 	+ 0x2f8 RelinquishedCommit : Pos 18, 1 Bit
	// 	+ 0x2f8 AutomaticallyOverrideChildProcessPolicy : Pos 19, 1 Bit
	// 	+ 0x2f8 HighGraphicsPriority : Pos 20, 1 Bit
	// 	+ 0x2f8 CommitFailLogged : Pos 21, 1 Bit
	// 	+ 0x2f8 ReserveFailLogged : Pos 22, 1 Bit
	// 	+ 0x2f8 DisableDynamicCodeAllowRemoteDowngrade : Pos 23, 1 Bit
	// 	+ 0x2f8 LoaderIntegrityContinuityEnabled : Pos 24, 1 Bit
	// 	+ 0x2f8 LoaderIntegrityContinuityAudit : Pos 25, 1 Bit
	// 	+ 0x2f8 ControlFlowGuardExportSuppressionEnabled : Pos 26, 1 Bit
	// 	+ 0x2f8 FatalAccessTerminationRequested : Pos 27, 1 Bit
	// 	+ 0x2f8 DisableSystemAllowedCpuSet : Pos 28, 1 Bit
	// 	+ 0x2f8 ControlFlowGuardStrict : Pos 29, 1 Bit
	...
	// 	+ 0x3e0 Flags4 : Uint4B
	// 	+ 0x3e0 PicoCreated : Pos 0, 1 Bit
	// 	+ 0x3e0 RestrictSetThreadContext : Pos 1, 1 Bit
	// 	+ 0x3e0 AddressPolicyFrozen : Pos 2, 1 Bit
	// 	+ 0x3e0 RestrictIndirectBranchPrediction : Pos 3, 1 Bit
	// 	+ 0x3e0 SpeculativeStoreBypassDisable : Pos 4, 1 Bit
	// 	+ 0x3e8 SecurityDomain : Uint8B

};

struct _MY_ETHREAD_WIN10_1703_X86_
{
	...
	// 	+ 0x3cc ReservedCrossThreadFlags : Pos 22, 10 Bits
	...
	// 	+ 0x3d0 ReservedSameThreadPassiveFlags : Pos 9, 23 Bits
...
struct _MY_KTHREAD_WIN10_1703_X86_
{
	...
	// 	+ 0x05c BamEppImportant : Pos 2, 1 Bit
	...
	// 	+ 0x05c ProcessStackCountDecremented : Pos 19, 1 Bit
