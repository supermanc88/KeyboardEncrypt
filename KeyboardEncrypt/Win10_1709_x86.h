...
struct _MY_EPROCESS_WIN10_1709_X86_
{
	...
	// 	+ 0x288 MmProcessLinks : _LIST_ENTRY
	// 	+ 0x290 ModifiedPageCount : Uint4B
	// 	+ 0x294 ExitStatus : Int4B
	// 	+ 0x298 VadRoot : _RTL_AVL_TREE
	// 	+ 0x29c VadHint : Ptr32 Void
	// 	+ 0x2a0 VadCount : Uint4B
	// 	+ 0x2a4 VadPhysicalPages : Uint4B
	// 	+ 0x2a8 VadPhysicalPagesLimit : Uint4B
	// 	+ 0x2ac AlpcContext : _ALPC_PROCESS_CONTEXT
	// 	+ 0x2bc TimerResolutionLink : _LIST_ENTRY
	// 	+ 0x2c4 TimerResolutionStackRecord : Ptr32 _PO_DIAG_STACK_RECORD
	// 	+ 0x2c8 RequestedTimerResolution : Uint4B
	// 	+ 0x2cc SmallestTimerResolution : Uint4B
	// 	+ 0x2d0 ExitTime : _LARGE_INTEGER
	// 	+ 0x2d8 ActiveThreadsHighWatermark : Uint4B
	// 	+ 0x2dc LargePrivateVadCount : Uint4B
	// 	+ 0x2e0 ThreadListLock : _EX_PUSH_LOCK
	// 	+ 0x2e4 WnfContext : Ptr32 Void
	// 	+ 0x2e8 ServerSilo : Ptr32 _EJOB
	// 	+ 0x2ec SignatureLevel : UChar
	// 	+ 0x2ed SectionSignatureLevel : UChar
	// 	+ 0x2ee Protection : _PS_PROTECTION
	// 	+ 0x2ef HangCount : Pos 0, 4 Bits
	// 	+ 0x2ef GhostCount : Pos 4, 4 Bits
	// 	+ 0x2f0 Flags3 : Uint4B
	// 	+ 0x2f0 Minimal : Pos 0, 1 Bit
	// 	+ 0x2f0 ReplacingPageRoot : Pos 1, 1 Bit
	// 	+ 0x2f0 Crashed : Pos 2, 1 Bit
	// 	+ 0x2f0 JobVadsAreTracked : Pos 3, 1 Bit
	// 	+ 0x2f0 VadTrackingDisabled : Pos 4, 1 Bit
	// 	+ 0x2f0 AuxiliaryProcess : Pos 5, 1 Bit
	// 	+ 0x2f0 SubsystemProcess : Pos 6, 1 Bit
	// 	+ 0x2f0 IndirectCpuSets : Pos 7, 1 Bit
	// 	+ 0x2f0 RelinquishedCommit : Pos 8, 1 Bit
	// 	+ 0x2f0 HighGraphicsPriority : Pos 9, 1 Bit
	// 	+ 0x2f0 CommitFailLogged : Pos 10, 1 Bit
	// 	+ 0x2f0 ReserveFailLogged : Pos 11, 1 Bit
	// 	+ 0x2f0 SystemProcess : Pos 12, 1 Bit
	// 	+ 0x2f0 HideImageBaseAddresses : Pos 13, 1 Bit
	// 	+ 0x2f4 DeviceAsid : Int4B
	// 	+ 0x2f8 SvmData : Ptr32 Void
	// 	+ 0x2fc SvmProcessLock : _EX_PUSH_LOCK
	// 	+ 0x300 SvmLock : Uint4B
	// 	+ 0x304 SvmProcessDeviceListHead : _LIST_ENTRY
	// 	+ 0x310 LastFreezeInterruptTime : Uint8B
	// 	+ 0x318 DiskCounters : Ptr32 _PROCESS_DISK_COUNTERS
	// 	+ 0x31c PicoContext : Ptr32 Void
	// 	+ 0x320 HighPriorityFaultsAllowed : Uint4B
	// 	+ 0x324 InstrumentationCallback : Ptr32 Void
	// 	+ 0x328 EnergyContext : Ptr32 _PO_PROCESS_ENERGY_CONTEXT
	...
	// 	+ 0x37c DxgProcess : Ptr32 Void
	// 	+ 0x380 Win32KFilterSet : Uint4B
	// 	+ 0x388 ProcessTimerDelay : _PS_INTERLOCKED_TIMER_DELAY_VALUES
	// 	+ 0x390 KTimerSets : Uint4B
	// 	+ 0x394 KTimer2Sets : Uint4B
	// 	+ 0x398 ThreadTimerSets : Uint4B
	// 	+ 0x39c VirtualTimerListLock : Uint4B
	// 	+ 0x3a0 VirtualTimerListHead : _LIST_ENTRY
	// 	+ 0x3a8 WakeChannel : _WNF_STATE_NAME
	// 	+ 0x3a8 WakeInfo : _PS_PROCESS_WAKE_INFORMATION
	// 	+ 0x3d8 MitigationFlags : Uint4B
	// 	+ 0x3d8 MitigationFlagsValues : <unnamed - tag>
	// 	+0x3dc MitigationFlags2 : Uint4B
	// 	+ 0x3dc MitigationFlags2Values : <unnamed - tag>
	// 	+0x3e0 PartitionObject : Ptr32 Void

};

struct _MY_ETHREAD_WIN10_1709_X86_
{
	...
	// 	+ 0x3cc ReservedCrossThreadFlags : Pos 23, 9 Bits
...
struct _MY_KTHREAD_WIN10_1709_X86_
{
