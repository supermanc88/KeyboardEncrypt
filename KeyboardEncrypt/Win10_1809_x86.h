...
struct _MY_EPROCESS_WIN10_1809_X86_
{
	...
	// 	+ 0x2f7 HangCount : Pos 0, 3 Bits
	// 	+ 0x2f7 GhostCount : Pos 3, 3 Bits
	// 	+ 0x2f7 PrefilterException : Pos 6, 1 Bit
	// 	+ 0x2f8 Flags3 : Uint4B
	...
	// 	+ 0x2f8 EnableProcessSuspendResumeLogging : Pos 19, 1 Bit
	// 	+ 0x2f8 EnableThreadSuspendResumeLogging : Pos 20, 1 Bit
	// 	+ 0x2f8 SecurityDomainChanged : Pos 21, 1 Bit
	// 	+ 0x2f8 SecurityFreezeComplete : Pos 22, 1 Bit
	// 	+ 0x2f8 VmProcessorHost : Pos 23, 1 Bit
	...
	// 	+ 0x3f8 ParentSecurityDomain : Uint8B
	// 	+ 0x400 CoverageSamplerContext : Ptr32 Void
	// 	+ 0x404 MmHotPatchContext : Ptr32 Void

};

struct _MY_ETHREAD_WIN10_1809_X86_
{
	...
	// 	+ 0x3d0 WorkloadClass : Pos 11, 1 Bit
	// 	+ 0x3d0 ReservedSameThreadPassiveFlags : Pos 12, 20 Bits
	...
	// 	+ 0x3d5 OwnsVadShared : Pos 5, 1 Bit
	...
	// 	+ 0x400 KernelStackReference : Uint4B
	// 	+ 0x404 BoostList : _LIST_ENTRY
	// 	+ 0x40c DeboostList : _LIST_ENTRY
	// 	+ 0x414 BoostListLock : Uint4B
	// 	+ 0x418 IrpListLock : Uint4B
	// 	+ 0x41c ReservedForSynchTracking : Ptr32 Void
	// 	+ 0x420 CmCallbackListHead : _SINGLE_LIST_ENTRY
	// 	+ 0x424 ActivityId : Ptr32 _GUID
	// 	+ 0x428 SeLearningModeListHead : _SINGLE_LIST_ENTRY
	// 	+ 0x42c VerifierContext : Ptr32 Void
	...
	// 	+ 0x468 HeapData : Uint4B
	// 	+ 0x46c OwnerEntryListHead : _LIST_ENTRY
	// 	+ 0x474 DisownedOwnerEntryListLock : Uint4B
	// 	+ 0x478 DisownedOwnerEntryListHead : _LIST_ENTRY

};

struct _MY_KTHREAD_WIN10_1809_X86_
{
	...
	// 	+ 0x058 CetShadowStack : Pos 20, 1 Bit
	// 	+ 0x058 Reserved : Pos 21, 11 Bits
